...
class Game:
    def __init__(self):
        ...
        self.check_if_lock = []
        #self.game_loop() SE EJECUTA EN CONSTRUCTOR ????


    """ Función que permita terminar el thread correctamente,
        sin terminar la ejecucion del proceso"""
    def endGame(self):
        self.game_is_running = False
        pygame.quit()
        print("MOVES FROM ENDGAME(): ", self.moves)
